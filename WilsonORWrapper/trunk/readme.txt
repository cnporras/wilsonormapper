...
WilsonORWrapper is a framework that wraps around Paul Wilson's O/R Mapper 
...
Note that the WilsonORMapper.dll that comes with this distribution has
limited functionality. For an unrestricted version you must purchase
it from Paul Wilson (for a measly $50.00). All other included libraries
have public licenses; license files are included alongside their binaries.
...
WilsonORWrapper Project:
	http://www.hosted-projects.com/trac/computersims/wilsonorwrapper/
WilsonORWrapper Google Group:
	http://groups.google.com/group/wilsonorwrapper/
WilsonORWrapper Subversion Repository:
	https://svn1.hosted-projects.com/computersims/wilsonorwrapper/
Paul Wilson's O/R Mapper: 
